...
const CTASection = () => {
  return (
    <section className="py-16 bg-collektiv-blue">
      <div className="container">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            <Link 
              to="/join" 
              className="bg-white text-collektiv-blue px-8 py-3 rounded-md font-medium hover:bg-blue-50 transition-colors flex items-center justify-center"
            >
              Join Now
