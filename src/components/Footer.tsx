...
const Footer = () => {
  return (
    <footer className="bg-collektiv-blue text-white pt-16 pb-6">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <h3 className="text-xl font-bold mb-4">COLLEKTIV.CLUB</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/membership" className="text-blue-100 hover:text-white transition-colors">
                  Membership
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/membership#benefits" className="text-blue-100 hover:text-white transition-colors">
                  Benefits
                </Link>
              </li>
              <li>
                <Link to="/membership#pricing" className="text-blue-100 hover:text-white transition-colors">
                  Pricing
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/membership#faq" className="text-blue-100 hover:text-white transition-colors">
                  FAQ
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <a href="mailto:info@collektiv.club" className="text-blue-100 hover:text-white transition-colors">
                  info@collektiv.club
                </a>
              </li>
              <li className="flex items-center">
