        ...
        <div className="mb-16">
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
            <Table>
              ...
              <TableBody>
                <TableRow>
                  <TableCell className="font-medium">Investment Fee</TableCell>
                ...
                <TableRow className="bg-gray-50">
                  <TableCell className="font-medium">Performance/Carry Fee</TableCell>
                ...
                <TableRow>
                  <TableCell className="font-medium">Annual Investment Fee</TableCell>
                  <TableCell className="text-center font-bold text-collektiv-green">0%</TableCell>
                  <TableCell className="text-center font-bold">0-10%</TableCell>
                </TableRow>
                <TableRow className="bg-gray-50">
                  <TableCell className="font-medium">Annual Membership</TableCell>
                  <TableCell className="text-center font-bold text-collektiv-green">Up to £985</TableCell>
                  <TableCell className="text-center font-bold">Up to £10,000</TableCell>
                </TableRow>
              </TableBody>
            </Table>
          </div>
