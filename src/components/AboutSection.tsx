        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8">
              {features.map((feature, index) => (
                <div key={index} className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-collektiv-lightblue mr-2 flex-shrink-0 mt-0.5" />
          ...
          <div className="order-1 lg:order-2">
            <div className="aspect-w-4 aspect-h-3 rounded-xl overflow-hidden shadow-xl">
              <div className="bg-gradient-to-br from-collektiv-blue to-collektiv-lightblue h-full w-full flex items-center justify-center p-8">
